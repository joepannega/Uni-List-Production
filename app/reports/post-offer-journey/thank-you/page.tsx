...
export const metadata: Metadata = {
  title: 'Your guide is ready — Uni-Life',
  robots: { index: false },
}
...
export default async function ThankYouPage({
  ...
  const downloadUrl = token
    ? `/reports/post-offer-journey/download?token=${encodeURIComponent(token)}`
    : null
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-sm ul-fg2 leading-relaxed mb-8">
            Your copy of{' '}
            <strong className="font-semibold" style={{ color: 'var(--ul-black)' }}>
          ...
          {downloadUrl ? (
            ...
            <p className="text-sm ul-fg2">
              ...
              <Link href="/reports/post-offer-journey" className="ul-accent underline">
